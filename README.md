...
Estilo común: panel `#2A2520` con borde dorado `#C9A24B` de 1–2 px, esquinas rectas (16-bit), sombra dura.

- **Caja de diálogo:** franja inferior; nombre del hablante en pestaña + retrato pixel 32×32 opcional; avance por toque; indicador ▸.
- **Panel de testimonio:** modal centrado; retrato + nombre + lugar + texto; sello "Guardado en el Diario".
- **Toast de evidencia:** notificación breve arriba; icono 📷 + "Evidencia añadida al Expediente".
- **Botones de menú:** lista vertical; ítem seleccionado con fondo `#D9A521` y texto oscuro.
- **Tooltip de zona bloqueada:** globo con candado + pista de qué falta.
- **Hojas de vida:** iconos de hoja (lleno / medio / vacío), de izquierda a derecha.
- **Barra de Vínculo:** turquesa; se vacía al usar a Yaku y se atenúa en zonas muertas.
...
- **v3.2** — *(este documento)* **Especificación de interfaz (UI) completa**: formato horizontal (480×270, 16:9), controles táctiles, sistema de diseño (paleta hex, tipografía, componentes), inventario de 16 pantallas y wireframes ASCII. README listo para que Claude Design construya las interfaces.

---

*GDD v3.2 — Para desarrollo con Godot 4.x | Android e iOS*
